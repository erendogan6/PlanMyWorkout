...
public class WorkoutRepository {
    ...
    @Inject
    public WorkoutRepository(FirebaseFirestore firestore, FirestoreManager firestoreManager) {
                    ...
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        if (document.exists()) {
                            ...
                            if (exercisesData != null) {
                                ...
                                // Now, for each exercise, try to get the latest log to populate progress data
                                return exercises;
                            }
                        }
                    }
